...
{
	PatriciaTreeStoreBinaryDifferentLenKeysDS tree;
	...
	REQUIRE(root->nodeType == NodeTypeOfPTSBDLK::LEAFNodeTypeOfPTSBDLK);
	...
	REQUIRE(root->nodeType == NodeTypeOfPTSBDLK::BRANCHNodeTypeOfPTSBDLK);
	...
	REQUIRE(nbranch->left->nodeType == NodeTypeOfPTSBDLK::LEAFNodeTypeOfPTSBDLK);
	...
	REQUIRE(nbranch->right->nodeType == NodeTypeOfPTSBDLK::LEAFNodeTypeOfPTSBDLK);
	...
	REQUIRE(nbranch->left->nodeType == NodeTypeOfPTSBDLK::BRANCHNodeTypeOfPTSBDLK);
	...
	REQUIRE(nbranch2->left->nodeType == NodeTypeOfPTSBDLK::LEAFNodeTypeOfPTSBDLK);
	nleaf1 = (NodeLeafOfPatriciaTreeStoreBinaryDifferentLenKeys*) nbranch2->left;
	REQUIRE(nleaf1 != nullptr);
	REQUIRE(nleaf1->data.compare("01010") == 0);
	
	REQUIRE(nbranch2->right->nodeType == NodeTypeOfPTSBDLK::LEAFNodeTypeOfPTSBDLK);
	...
	REQUIRE(nbranch->right->nodeType == NodeTypeOfPTSBDLK::BRANCHNodeTypeOfPTSBDLK);
	...
	REQUIRE(nbranch3->left->nodeType == NodeTypeOfPTSBDLK::LEAFNodeTypeOfPTSBDLK);
	nleaf3 = (NodeLeafOfPatriciaTreeStoreBinaryDifferentLenKeys*) nbranch3->left;
	REQUIRE(nleaf3 != nullptr);
	REQUIRE(nleaf3->data.compare("11010") == 0);
	
	REQUIRE(nbranch3->right->nodeType == NodeTypeOfPTSBDLK::LEAFNodeTypeOfPTSBDLK);
...
TEST_CASE( "Testing the insert call in the patriciatreestorebinarydifferentlenkeys, with diferent lengths", "[single-file]" )
{
	...
	//new leaf
	REQUIRE(nbranch3->missing->nodeType == NodeTypeOfPTSBDLK::LEAFNodeTypeOfPTSBDLK);
	...
	//new leaf
	REQUIRE(nbranch2->missing->nodeType == NodeTypeOfPTSBDLK::LEAFNodeTypeOfPTSBDLK);
	...
	REQUIRE(nbranch2->right->nodeType == NodeTypeOfPTSBDLK::BRANCHNodeTypeOfPTSBDLK);
	...
	REQUIRE(nbranch4->left->nodeType == NodeTypeOfPTSBDLK::LEAFNodeTypeOfPTSBDLK);
	nleaf1 = (NodeLeafOfPatriciaTreeStoreBinaryDifferentLenKeys*) nbranch4->left;
	REQUIRE(nleaf1 != nullptr);
	REQUIRE(nleaf1->data.compare("01010") == 0);
	
	REQUIRE(nbranch4->right->nodeType == NodeTypeOfPTSBDLK::LEAFNodeTypeOfPTSBDLK);
	nleaf2 = (NodeLeafOfPatriciaTreeStoreBinaryDifferentLenKeys*) nbranch4->right;
	REQUIRE(nleaf2 != nullptr);
	REQUIRE(nleaf2->data.compare("01011") == 0);
	
	//it is missing one
	REQUIRE(nbranch4->missing->nodeType == NodeTypeOfPTSBDLK::LEAFNodeTypeOfPTSBDLK);
